...
//Triangle
        ...
        face6.setEmmission(new Color(37, 113, 255));
       ...
       scene.addLight(new PointLight(new Color(255, 183, 138),new Point3D(-200,-100,0),0, 0.000001, 0.0000005));

        scene.getAmbientLight();
        ImageWriter imageWriter = new ImageWriter("cube test2", 500, 500, 500, 500);
